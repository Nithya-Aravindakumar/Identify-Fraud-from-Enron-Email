...
# Decision Tree
print "\nDecision Tree"
clf3 = tree.DecisionTreeClassifier(criterion='gini', splitter='best', random_state=42)
train_predict(clf3)
...
#Random Forest
print "\nRandomForest"
clf6 = RandomForestClassifier(n_estimators = 1, criterion = "entropy", random_state=42 )
train_predict(clf6)
